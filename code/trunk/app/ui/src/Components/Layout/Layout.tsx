...
import { SaleRecordsPage } from "../Pages/Main/SaleRecordsPage";
import { MergeRecordsPage } from "../Pages/Main/MergeRecordsPage";
import { SplitRecordsPage } from "../Pages/Main/SplitRecordsPage";
          ...
          <div className={classes.root}>
            <>
              ...
              <div className={classes.content}>
                ...
                <Switch>
                  <Route path="/app/sale_recs" component={SaleRecordsPage} />
                </Switch>
                <Switch>
                  <Route path="/app/merge_recs" component={MergeRecordsPage} />
                </Switch>
                <Switch>
                  <Route path="/app/split_recs" component={SplitRecordsPage} />
                </Switch>
              </div>
            </>
          </div>
