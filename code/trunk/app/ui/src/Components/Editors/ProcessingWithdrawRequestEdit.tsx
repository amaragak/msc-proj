...
interface ProcessingWithdrawRequestEditProps {
  open: boolean;
  onClose: () => void;
  user: UserState;
  product: Product;
...
interface ProcessingWithdrawRequestEditState {
  request: ProcessingRequest | undefined;
  requestCid: ContractId<ProcessingRequest> | undefined;
}

export class ProcessingWithdrawRequestEdit extends React.Component<ProcessingWithdrawRequestEditProps, ProcessingWithdrawRequestEditState> {
  constructor(props: ProcessingWithdrawRequestEditProps) {
    super(props);
    this.state = this.initialState();
  }

  private initialState(): ProcessingWithdrawRequestEditState {
    return {
      request: undefined, 
  ...
  private putWithdrawToLedger = () => {
    ...
    ledger.exercise(ProcessingRequest.WithdrawProcessingRequest, requestCid, {})
      .then(() => this.onClose());
  }
  ...
  render() {
    return (
      <InputDialog
        title="Withdraw Processing Request"
